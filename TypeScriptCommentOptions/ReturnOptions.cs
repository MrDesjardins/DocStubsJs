...
namespace TypeScriptCommentOptions
{
    public class ReturnOptions
    {
        ...
        private bool typeScriptCommentExtensionEnabled = false;
        public bool TypeScriptCommentExtensionEnabled
        {
            get
            {
                LoadSettingsFromStorage();
                return typeScriptCommentExtensionEnabled;
            }
            set { typeScriptCommentExtensionEnabled = value; }
        }
        ...
        private void LoadSettingsFromStorage()
        {
            if (OptionsChanged)
            {
                ...
                TypeScriptCommentExtensionEnabled = UpdateSetting("TypeScriptCommentExtensionEnabled", true);
        ...
        {
            return GetSetting("DialogPage\\TypeScriptCommentOptions.Options", name, defaultValue);
        }
